...
const card = [
  {
    id: 1,
    src: "http://res.cloudinary.com/dxpahuuq1/image/upload/v1715869967/devBoard/jvezaxuwzgiocny47ptj.jpg",
    alt: "post",
    width: 1920,
    height: 1080,
            ...
            {card.map((item) => (
              ...
              >
                ...
                <div className="z-10">
                  ...
                  <p className="w-1/2 text-2xl my-4">
                    What’s next for the drones in film making
                  </p>
